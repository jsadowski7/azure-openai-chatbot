...
const chatHistory_1 = require("./chatHistory"); // Import chat history management
...
function main() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        rl.on("line", (userInput) => __awaiter(this, void 0, void 0, function* () {
            ...
            chatHistory_1.chatHistory.push({ role: "user", content: userInput }); // Add user input to chat history
            try {
                const response = yield client.chat.completions.create({
                    messages: chatHistory_1.chatHistory,
                    max_tokens: 4096,
                    temperature: 1,
                    top_p: 1,
                    model: modelName
                ...
                console.log("\nChatbot:", reply);
                chatHistory_1.chatHistory.push({ role: "assistant", content: reply !== null && reply !== void 0 ? reply : "" }); // Add the assistant's reply to chat history
            }
            catch (err) {
